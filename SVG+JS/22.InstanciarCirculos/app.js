...
setInterval(()=>{listaCirculos.push(new Circulo(document.createElementNS('http://www.w3.org/2000/svg','circle'),document.getElementById('svg'),100,100,20,'brown',1,1,1))},5000)
